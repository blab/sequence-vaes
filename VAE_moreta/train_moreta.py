...
def main(args):
    ...
    print("alignment exists: %s"%(str(os.path.isfile(args.alignment_file))))
    print("sequences exists: %s"%(str(os.path.isfile(args.fasta_file))))
    print("tree exists: %s"%(str(os.path.isfile(args.tree_file))))
